class MainScene3 extends Phaser.Scene {
    constructor() {
        super("mainScene3");
    ...
    create() {
        ...
        document.getElementById('description').innerHTML = '<h2>Level 3</h2><br>A: left // D: right // Space: fire/emit // S: Next Scene'
        ...
        //Rabbits (Right)
        for (let i = 0; i < 1; i++) {
            let enemy = new Enemy(this, this.curve3, 650, 200, "rabbit");
    ...
    update() {
        ...
        if (allDead) {
            ...
            this.time.delayedCall(4000, () => {
                this.scene.start("mainScene4", { score: this.myScore });
            });
         }
        }
    }
